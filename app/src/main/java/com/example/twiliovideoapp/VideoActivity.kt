...
import kotlinx.android.synthetic.main.layout_content_video.*
import kotlinx.android.synthetic.main.layout_content_video.thumbnailVideoView
...
class VideoActivity : AppCompatActivity() {
    ...
    private var twilioAccountSid: String? = null //"SK180c2238f5574db317b0212aecd87d79"
    private var secret: String? =
        null //getString (R.string.twillio_secret)//"9PuhN3qE64X7MPjTFxhL8OzeCJneFrDA"
    private var apiKey: String? = null //getString (R.string.api_key)
     ...
     */
    private lateinit var TWILIO_ACCESS_TOKEN: String
    ...
    private val roomListener = object : Room.Listener {
        ...
        override fun onReconnecting(room: Room, twilioException: TwilioException) {
            ...
            Log.d("log", "--------------> on Reconnecting ${twilioException.message}")
        ...
        override fun onConnectFailure(room: Room, e: TwilioException) {
            ...
            Log.d("log", "--------------> on connection failure ${e.message}")
            initializeUI()
        }
        ...
        override fun onDisconnected(room: Room, e: TwilioException?) {
            ...
            Log.d("log", "--------------> on Disconnected ${e!!.message}")
        ...
        override fun onParticipantConnected(room: Room, participant: RemoteParticipant) {
            Toast.makeText(this@VideoActivity, "participant connected ", Toast.LENGTH_SHORT).show()
            addRemoteParticipant(participant)
            Log.d("log", "--------------> on Participant connected")
            Log.d(
                "log",
                "--------------> room status when participant joined ${room.state} ------------------> remote participant value ${participant.identity} "
            )
            // setDisconnectAction()
        }
        ...
        override fun onParticipantDisconnected(room: Room, participant: RemoteParticipant) {
            ...
            Log.d("log", "--------------> on participant  Disconnected ")
            Log.d(
                "log",
                "--------------> room status when participant Disconnected ${room.state} ------------------> remote participant value ${participant.identity} "
            )
        }
    ...
    fun createAccessToken(identity: String?): String {
        // Required for Video
        val userIdentity = identity //it will first open then the dialog would be the
        ...
        TWILIO_ACCESS_TOKEN = token?.toJwt().toString()
        Log.d("token", "Token_________________________________> ${token?.toJwt()}")
    ...
    private val participantListener = object : RemoteParticipant.Listener {
        override fun onAudioTrackPublished(
            ...
            Log.d(
                TAG, "_________________________________> onAudioTrackPublished: " +
        ...
        override fun onAudioTrackUnpublished(
            ...
            Log.d(
                TAG, "_________________________________> onAudioTrackUnpublished: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteAudioTrackPublication: sid=${remoteAudioTrackPublication.trackSid}, " +
                        "enabled=${remoteAudioTrackPublication.isTrackEnabled}, " +
                        "subscribed=${remoteAudioTrackPublication.isTrackSubscribed}, " +
        ...
        override fun onDataTrackPublished(
            ...
            Log.d(
                TAG, "_________________________________>onDataTrackPublished: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
        ...
        override fun onDataTrackUnpublished(
            ...
            Log.d(
                TAG, "_________________________________> onDataTrackUnpublished: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteDataTrackPublication: sid=${remoteDataTrackPublication.trackSid}, " +
                        "enabled=${remoteDataTrackPublication.isTrackEnabled}, " +
                        "subscribed=${remoteDataTrackPublication.isTrackSubscribed}, " +
        ...
        override fun onVideoTrackPublished(
            ...
            Log.d(
                TAG, "_________________________________> onVideoTrackPublished: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
        ...
        override fun onVideoTrackUnpublished(
            ...
            Log.d(
                TAG, "_________________________________> onVideoTrackUnpublished: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteVideoTrackPublication: sid=${remoteVideoTrackPublication.trackSid}, " +
                        "enabled=${remoteVideoTrackPublication.isTrackEnabled}, " +
                        "subscribed=${remoteVideoTrackPublication.isTrackSubscribed}, " +
        ...
        override fun onAudioTrackSubscribed(
            ...
            Log.d(
                TAG, " _________________________________> onAudioTrackSubscribed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
        ...
        override fun onAudioTrackUnsubscribed(
            ...
            Log.d(
                TAG, "_________________________________> onAudioTrackUnsubscribed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteAudioTrack: enabled=${remoteAudioTrack.isEnabled}, " +
                        "playbackEnabled=${remoteAudioTrack.isPlaybackEnabled}, " +
                        "name=${remoteAudioTrack.name}]"
        ...
        override fun onAudioTrackSubscriptionFailed(
            ...
            Log.d(
                TAG, "_________________________________> onAudioTrackSubscriptionFailed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteAudioTrackPublication: sid=${remoteAudioTrackPublication.trackSid}, " +
                        "name=${remoteAudioTrackPublication.trackName}]" +
        ...
        override fun onDataTrackSubscribed(
            ...
            Log.d(
                TAG, "_________________________________> onDataTrackSubscribed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
        ...
        override fun onDataTrackUnsubscribed(
            ...
            Log.d(
                TAG, "_________________________________> onDataTrackUnsubscribed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteDataTrack: enabled=${remoteDataTrack.isEnabled}, " +
                        "name=${remoteDataTrack.name}]"
            )
        ...
        override fun onDataTrackSubscriptionFailed(
            ...
            Log.d(
                TAG, "_________________________________> onDataTrackSubscriptionFailed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteDataTrackPublication: sid=${remoteDataTrackPublication.trackSid}, " +
                        "name=${remoteDataTrackPublication.trackName}]" +
                        "[TwilioException: code=${twilioException.code}, " +
        ...
        override fun onVideoTrackSubscribed(
            ...
            Log.d(
                TAG, "_________________________________> onVideoTrackSubscribed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
        ...
        override fun onVideoTrackUnsubscribed(
            ...
            Log.d(
                TAG, " _________________________________> onVideoTrackUnsubscribed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteVideoTrack: enabled=${remoteVideoTrack.isEnabled}, " +
                        "name=${remoteVideoTrack.name}]"
            )
        ...
        override fun onVideoTrackSubscriptionFailed(
            ...
            Log.d(
                TAG, "_________________________________> onVideoTrackSubscriptionFailed: " +
                        "[RemoteParticipant: identity=${remoteParticipant.identity}], " +
                        "[RemoteVideoTrackPublication: sid=${remoteVideoTrackPublication.trackSid}, " +
                        "name=${remoteVideoTrackPublication.trackName}]" +
                        "[TwilioException: code=${twilioException.code}, " +
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // val myPrefs: SharedPreferences = getSharedPreferences(getString(R.string.app_name), MODE_PRIVATE)
        //   identity = myPrefs.getString("identity", "")

        twilioAccountSid = getString(R.string.twillio_sid)
        apiKey = getString(R.string.api_key)
        secret = getString(R.string.twillio_secret)
        authToken = getString(R.string.authToken)
        /*Twilio.init(twilioAccountSid, authToken)
        val newKey = NewKey.creator().setFriendlyName("newApikey").create()
        apiKey = newKey.friendlyName
        ...
        */
        ...
        //createAccessToken()
        // this should be there every time you coonect to room because you suppose to be different user while connecting a room for a demo w
    ...
    override fun onResume() {
        ...
        room?.let {
            Log.d(
                "log",
                "_________________________________> when in on resume -> room state = ${it.state}"
            )
    ...
    override fun onPause() {
         ...
         * participant before releasing the vide track. Participants will be notified that
    ...
    private fun createAudioAndVideoTracks() {
        ...
        localDataTrack = LocalDataTrack.create(this@VideoActivity)
    ...
    private fun connectToRoom(roomName: String, identity: String) {
        audioSwitch.activate()

        createAccessToken(identity)
        setAccessToken()

        room = connect(this@VideoActivity, accessToken, roomListener) {
            roomName(roomName)
            ...
            val connectOptions = ConnectOptions.Builder(accessToken).roomName(roomName)
                .audioTracks(listOf(localAudioTrack))
                .videoTracks(listOf(localVideoTrack))
                .dataTracks(listOf(localDataTrack))
                .build()
            room = Video.connect(this@VideoActivity, connectOptions, roomListener);
    ...
    private fun initializeUI() {
        ...
        changeAudioOutput.setOnClickListener {
            showAudioDevices()
        }
    ...
    private fun updateAudioDeviceIcon(selectedAudioDevice: AudioDevice?) {
        val audioDeviceMenuIcon = when (selectedAudioDevice) {
            is BluetoothHeadset -> R.drawable.ic_baseline_bluetooth_24
            is WiredHeadset -> R.drawable.ic_baseline_headset_mic_24
            is Speakerphone -> R.drawable.ic_baseline_volume_up_24
            else -> R.drawable.ic_baseline_phonelink_ring_24
        }
    ...
    private fun showConnectDialog() {
        ...
        val identity = EditText(this)
        alertDialog = createConnectDialog(
            roomEditText, identity,
            connectClickListener(roomEditText, identity), cancelConnectDialogClickListener(), this
        )
        alertDialog?.show()
    }
    ...
    private fun connectClickListener(
        roomEditText: EditText,
        identityEditText: EditText
    ): DialogInterface.OnClickListener {
        return DialogInterface.OnClickListener { _, _ ->
            /*
             * Connect to room
             */
            connectToRoom(roomEditText.text.toString(), identityEditText.text.toString())
        }
    }
...
/*
    ...
    private fun createConnectDialog(
        ...
        val alertDialogBuilder = AlertDialog.Builder(context).apply {
            setIcon(R.drawable.ic_baseline_video_call_24)
        ...
        setRoomNameFieldInDialog(participantEditText, identityEditText, alertDialogBuilder, context)
        // setRoomNameFieldInDialog(identityEditText, alertDialogBuilder, context)
    ...
    private fun setRoomNameFieldInDialog(
        ...
        roomNameEditText.background = null
        identityEditText.background = null

        identityEditText.hint = "User Name"
        ...
        roomNameEditText.setPadding(
            horizontalPadding,
            verticalPadding,
            horizontalPadding,
            0
        )
        identityEditText.setPadding(
            horizontalPadding,
            verticalPadding,
            horizontalPadding,
            0
        ...
        layout.addView(identityEditText)
